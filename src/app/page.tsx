...
const CORE_FEATURES = [
  {
    ...
    desc: 'An inquiry lands in the channel the customer uses — email or WhatsApp — and Vectra drives it through the whole sourcing pipeline from there.',
...
const FAQS = [
  {
    ...
    a: 'Yes. Vectra works over your existing mailbox — an inquiry can arrive from a customer or be added in one click. There is no new software for your team, your customers, or your suppliers to learn.',
  },
  {
    q: 'Does it work with WhatsApp?',
    a: 'Yes. Vectra works over email and WhatsApp, depending on what the customer or supplier prefers. Specs are extracted the same way, and replies route back through the channel you choose — ideal for Shenzhen and mainland suppliers who live on WeChat and WhatsApp.',
  },
  {
    q: 'Can it handle Chinese and mixed-language emails?',
    a: 'Vectra extracts specs from English, Simplified Chinese, Traditional Chinese, and mixed-language threads — common in HK and SZ trade.',
  },
  {
  ...
  },
  {
    ...
    a: 'Vectra is a pipeline, not a chat window. It ties each step to your data — your products, suppliers, margins, and FX rates — and keeps a human approving every outbound message. A generic chatbot can write a reply; it can\'t RFQ your suppliers, compare landed costs, or draft a quote you can trace.',
  },
  {
      ...
      <section className="pt-36 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <p className="btk-anim-rise text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed" style={{ color: '#555555', animationDelay: '330ms' }}>
            Vectra is the AI copilot for trading companies. It takes a customer inquiry, extracts every spec, checks for gaps, RFQs your suppliers, compares their responses with cited landed costs, and drafts a ready-to-send quote — in hours, not days.
          </p>
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <Reveal className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg mb-10" style={{ color: '#555555' }}>
            Vectra helps trading companies in HK, Shenzhen, and beyond quote faster and win more deals.
          </p>
        ...
        <div className="max-w-6xl mx-auto grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              <img src="/brand/vectra-mark.png" alt="Vectra" className="h-8 w-8 rounded object-cover" />
              <span className="text-sm font-semibold" style={{ color: '#0A0A0A' }}>Vectra</span>
            </div>
            ...
            <p className="text-xs mt-6" style={{ color: '#9A9A9A' }}>© 2026 Vectra. All rights reserved.</p>
          </div>
          <div>
