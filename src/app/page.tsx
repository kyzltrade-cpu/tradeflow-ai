...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)', color: 'var(--text)' }}>
      {/* Nav */}
      <nav className="absolute top-0 left-0 right-0 z-20" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <span className="text-[17px] font-semibold tracking-[-0.3px]" style={{ color: '#FFFFFF' }}>
              TradeFlow
            </span>
            <div className="hidden md:flex items-center gap-6 text-[14px]" style={{ color: 'rgba(255,255,255,0.65)' }}>
              <a href="#how-it-works" className="hover:text-white transition-colors">{t('How it works', '運作方式')}</a>
              <a href="#features" className="hover:text-white transition-colors">{t('Features', '功能')}</a>
              <a href="#pricing" className="hover:text-white transition-colors">{t('Pricing', '定價')}</a>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <LangToggle />
            <Link href="/login" className="hidden md:inline text-[14px] hover:text-white transition-colors" style={{ color: 'rgba(255,255,255,0.65)' }}>
              {t('Login', '登入')}
            </Link>
            <Link
              href="/signup"
      ...
      {/* Hero */}
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(145deg, #0A6E5C 0%, #085C4D 40%, #064E3B 100%)' }}>
        {/* Dot grid pattern */}
        ...
        {/* Soft glow */}
        <div className="absolute top-0 right-0 w-[600px] h-full opacity-[0.06]" style={{
          background: 'radial-gradient(ellipse at 80% 50%, #34d399, transparent 70%)',
        }} />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] opacity-[0.04]" style={{
          background: 'radial-gradient(circle at 20% 80%, #a7f3d0, transparent 60%)',
        }} />
        <div className="max-w-[1200px] mx-auto px-6 pt-28 pb-18 md:pt-36 md:pb-32 relative z-10">
          <div className="flex flex-col md:flex-row items-start gap-10 md:gap-16">
            {/* Left: copy */}
            <div className="w-full md:w-[56%] pt-0 md:pt-4">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-6 md:mb-8" style={{ background: 'rgba(255,255,255,0.1)' }}>
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-300 animate-pulse" />
                <span className="text-[11px] md:text-[12px] font-medium" style={{ color: '#a7f3d0' }}>
                  {t('AI-powered workflow for HK trading companies', 'AI 驅動的香港貿易公司工作流程')}
                </span>
              </div>
              <h1 className="text-[34px] md:text-[54px] leading-[1.1] md:leading-[1.05] font-semibold tracking-[-1px] md:tracking-[-1.5px] mb-5 md:mb-6" style={{ color: '#FFFFFF' }}>
                {t('Turn inquiries into quotes in minutes', '幾分鐘內將查詢轉化為報價')}
              </h1>
              <p className="text-[16px] md:text-[18px] leading-[1.6] md:leading-[1.65] mb-8 md:mb-10 max-w-[500px]" style={{ color: 'rgba(255,255,255,0.7)' }}>
                {t(
                  'From WhatsApp message to professional quote — with supplier RFQs, margin controls, and automated follow-ups. Built for Hong Kong trading companies.',
                  '從 WhatsApp 訊息到專業報價——附帶供應商 RFQ、利潤控制和自動跟進。專為香港貿易公司打造。'
                )}
              </p>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-10 mt-14">
                <Link
                  href="/login"
              ...
              <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-[12px] md:text-[13px]" style={{ color: 'rgba(255,255,255,0.5)' }}>
                <span className="flex items-center gap-1.5">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                  {t('14-day free trial', '14 天免費試用')}
                </span>
                <span className="flex items-center gap-1.5">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                  {t('No contracts', '無合約')}
      ...
      <section className="border-b" style={{ borderColor: 'var(--border)', background: 'var(--surface)' }}>
        <div className="max-w-[1200px] mx-auto px-6 py-10 md:py-12 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          <div>
            <p className="text-[32px] md:text-[36px] font-semibold tracking-[-1px]" style={{ color: 'var(--accent)' }}>7x</p>
            <p className="text-[13px] md:text-[14px] mt-1" style={{ color: 'var(--text-muted)' }}>
              {t('More likely to close when you reply within 1 hour', '1 小時內回覆，成交率提升 7 倍')}
            </p>
          </div>
          <div>
            <p className="text-[32px] md:text-[36px] font-semibold tracking-[-1px]" style={{ color: 'var(--accent)' }}>24/7</p>
            <p className="text-[13px] md:text-[14px] mt-1" style={{ color: 'var(--text-muted)' }}>
              {t('Coverage across every time zone, every day', '全天候覆蓋所有時區')}
            </p>
          </div>
          <div>
            <p className="text-[32px] md:text-[36px] font-semibold tracking-[-1px]" style={{ color: 'var(--accent)' }}>5 min</p>
            <p className="text-[13px] md:text-[14px] mt-1" style={{ color: 'var(--text-muted)' }}>
              {t('From setup to first AI-generated quote', '從設定到第一份 AI 生成報價')}
            </p>
          </div>
          <div>
            <p className="text-[32px] md:text-[36px] font-semibold tracking-[-1px]" style={{ color: 'var(--accent)' }}>4</p>
            <p className="text-[13px] md:text-[14px] mt-1" style={{ color: 'var(--text-muted)' }}>
              {t('Languages — auto-detected per conversation', '語言——每段對話自動偵測')}
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-24">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-[26px] md:text-[32px] font-semibold tracking-[-0.8px] mb-4">
              {t('From inquiry to quote in 4 steps', '4 個步驟從查詢到報價')}
            </h2>
            <p className="text-[16px] max-w-[560px] mx-auto" style={{ color: 'var(--text-muted)' }}>
              {t('No more spreadsheets, email chains, or manual tracking. TradeFlow automates the entire RFQ workflow.', '不再需要電子表格、電郵鏈或手動跟蹤。TradeFlow 自動化整個 RFQ 工作流程。')}
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="hidden md:block absolute top-[32px] left-[calc(12.5%+16px)] right-[calc(12.5%+16px)] h-px" style={{ background: 'var(--border)' }} />
            ...
            <div className="grid md:grid-cols-4 gap-8 md:gap-6">
              {[
                ...
                },
                {
                  ...
                  title_en: 'AI extracts requirements',
                  title_zh: 'AI 提取需求',
                  desc_en: 'Product specs, quantity, destination, delivery date — all parsed and structured automatically.',
                  desc_zh: '產品規格、數量、目的地、交貨日期——全部自動解析並結構化。',
                },
                {
                  num: '3',
                  icon: (
                  ...
                  title_en: 'Suppliers quote back',
                  title_zh: '供應商報價',
                  desc_en: 'Send RFQs to multiple suppliers, receive and compare quotes side by side.',
                  desc_zh: '向多個供應商發送 RFQ，接收並進行並排比較。',
                },
                {
                  num: '4',
                  icon: (
                  ...
                  title_en: 'Quote sent, deal closed',
                  title_zh: '報價發出，成交訂單',
                  desc_en: 'Generate a professional quote with margin controls and send it. Follow-ups happen automatically.',
                  desc_zh: '生成帶有利潤控制的專業報價並發送。跟進自動完成。',
                },
              ].map((step, i) => (
                <div key={i} className="text-center relative">
                  <div className="w-[64px] h-[64px] rounded-[12px] mx-auto mb-5 flex items-center justify-center relative z-10" style={{ background: 'var(--accent)', color: '#FFFFFF' }}>
                    {step.icon}
                  </div>
                  <h3 className="text-[16px] font-semibold mb-2">{t(step.title_en, step.title_zh)}</h3>
                  <p className="text-[14px] leading-[1.6]" style={{ color: 'var(--text-muted)' }}>
                    {t(step.desc_en, step.desc_zh)}
                  </p>
                </div>
              ))}
            </div>
      ...
      <section style={{ background: 'var(--surface)' }}>
        <div className="max-w-[800px] mx-auto px-4 md:px-6 py-16 md:py-24">
          <div className="text-center mb-8">
            ...
            <p className="text-[14px] max-w-[480px] mx-auto" style={{ color: 'var(--text-muted)' }}>
              {t('Paste your website link or chat with the AI to explore what it can do for your trading business.', '貼上您的網站連結或與 AI 對話，探索其如何幫助您的貿易業務。')}
            </p>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-24">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-[16px] max-w-[600px] mx-auto" style={{ color: 'var(--text-muted)' }}>
              {t('Built for HK trading companies handling RFQs, supplier quotes, and customer negotiations.', '專為處理 RFQ、供應商報價和客戶談判的香港貿易公司打造。')}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                title_en: 'AI Requirement Extraction',
                title_zh: 'AI 需求提取',
                desc_en: 'AI parses product specs, quantity, destination, and delivery dates from free-text messages. Structured data ready for RFQ.',
                desc_zh: 'AI 從自由文本訊息中解析產品規格、數量、目的地和交貨日期。結構化資料準備用於 RFQ。',
              },
              {
                icon: (
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                title_en: 'Supplier RFQ & Quotes',
                title_zh: '供應商 RFQ 與報價',
                desc_en: 'Send RFQs to multiple suppliers, receive quotes, and compare side-by-side with unit price, MOQ, lead time, and total cost.',
                desc_zh: '向多個供應商發送 RFQ，接收報價並進行並排比較，包括單價、MOQ、交貨期和總成本。',
              },
              {
                icon: (
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                title_en: 'Cost Build-Up & Margin',
                title_zh: '成本明細與利潤',
                desc_en: 'Deterministic cost calculator with min-margin rules, FX conversion, and incoterm-aware pricing. Never sell below your floor.',
                desc_zh: '確定性成本計算器，帶有最低利潤規則、匯率轉換和貿易術語感知定價。絕不低於底價出售。',
              },
              {
                icon: (
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                title_en: 'Customer Quote Builder',
                title_zh: '客戶報價生成器',
                desc_en: 'Generate professional quotes with line items, cost breakdowns, and version history. Requires approval before sending to customers.',
                desc_zh: '生成帶有明細項目、成本明細和版本歷史的專業報價。發送給客戶前需要審批。',
              },
              {
                icon: (
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                title_en: 'Automated Follow-ups',
                title_zh: '自動跟進',
                desc_en: 'Schedule follow-up sequences after sending quotes. Nudge customers at the right time without manual tracking.',
                desc_zh: '發送報價後安排跟進序列。在適當時間提醒客戶，無需手動跟蹤。',
              },
            ].map((feature, i) => (
              <div key={i} className="border rounded-[10px] p-6 hover:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] transition-shadow" style={{ borderColor: 'var(--border)', background: 'var(--bg)' }}>
                <div className="w-10 h-10 rounded-[8px] flex items-center justify-center mb-4" style={{ background: 'var(--accent-light)' }}>
                  {feature.icon}
                </div>
                <h3 className="text-[16px] font-semibold mb-2">{t(feature.title_en, feature.title_zh)}</h3>
                <p className="text-[14px] leading-[1.5]" style={{ color: 'var(--text-muted)' }}>
                  {t(feature.desc_en, feature.desc_zh)}
                </p>
              </div>
            ))}
          </div>
      ...
      <section style={{ background: 'var(--surface)' }}>
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-20">
          <div className="border rounded-[12px] p-6 md:p-8" style={{ borderColor: 'var(--accent)', background: 'var(--bg)', boxShadow: '0 0 0 1px var(--accent), 0 4px 24px rgba(0,0,0,0.06)' }}>
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-[8px] flex items-center justify-center shrink-0" style={{ background: 'var(--accent-light)' }}>
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  {[
                    { title_en: 'Excel catalog ingestion', title_zh: 'Excel 目錄匯入', desc_en: 'Upload your product list directly', desc_zh: '直接上傳產品清單' },
                    { title_en: 'Strict non-disclosure rules', title_zh: '嚴格保密規則', desc_en: 'AI never reveals pricing to wrong parties', desc_zh: 'AI 絕不向錯誤方透露價格' },
                    { title_en: 'Instant human-takeover pings', title_zh: '即時人手接管通知', desc_en: 'Get alerted the moment a deal needs you', desc_zh: '交易需要您時立即收到提醒' },
                  ].map((item, i) => (
                    <div key={i} className="flex items-start gap-2.5">
                      ...
                      <div>
                        <p className="text-[13px] font-medium">{t(item.title_en, item.title_zh)}</p>
                        <p className="text-[12px]" style={{ color: 'var(--text-muted)' }}>{t(item.desc_en, item.desc_zh)}</p>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      <section id="pricing">
        <div className="max-w-[1100px] mx-auto px-6 py-16 md:py-24">
          ...
          <div className="grid md:grid-cols-3 gap-6 items-stretch">
            {/* Lead Desk - HK$880 */}
            <div className="border rounded-[10px] p-6 flex flex-col" style={{ borderColor: 'var(--border)', background: 'var(--bg)' }}>
              <div className="mb-3">
                ...
                <div className="flex items-baseline gap-1 mt-3">
                  ...
                  <span className="text-[32px] font-semibold tracking-[-1px]">880</span>
                  <span className="text-[13px]" style={{ color: 'var(--text-muted)' }}>/mo</span>
                </div>
              </div>
              <div className="space-y-2.5 mt-5 flex-1">
                {[
                  t('Unified inquiry inbox', '統一查詢收件箱'),
                  t('AI auto-response & extraction', 'AI 自動回覆與提取'),
                  t('Multi-language auto-detect', '多語言自動偵測'),
              ...
              <Link
                href="/login"
                className="block w-full text-center text-[13px] font-medium py-2.5 rounded-[4px] mt-6 border hover:opacity-80 transition-opacity"
                style={{ borderColor: 'var(--accent)', color: 'var(--accent)' }}
              >
                {t('Start free trial', '免費試用')}
              </Link>
            </div>

            {/* Quote Desk - HK$2,480 */}
            <div className="border rounded-[10px] p-6 flex flex-col relative" style={{ borderColor: 'var(--accent)', background: 'var(--bg)', boxShadow: '0 0 0 1px var(--accent)' }}>
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full text-[11px] font-semibold" style={{ background: 'var(--accent)', color: '#FFFFFF' }}>
                {t('MOST POPULAR', '最受歡迎')}
              </div>
              <div className="mb-3">
                ...
                <div className="flex items-baseline gap-1 mt-3">
                  <span className="text-[13px]" style={{ color: 'var(--text-muted)' }}>HK$</span>
                  <span className="text-[32px] font-semibold tracking-[-1px]">2,480</span>
                  <span className="text-[13px]" style={{ color: 'var(--text-muted)' }}>/mo</span>
                </div>
              </div>
              <div className="space-y-2.5 mt-5 flex-1">
                {[
                  ...
                  t('AI requirement extraction', 'AI 需求提取'),
              ...
              <Link
                href="/login"
                className="block w-full text-center text-[13px] font-medium py-2.5 rounded-[4px] mt-6 text-white hover:opacity-90 transition-opacity"
            ...
            <div className="border rounded-[10px] p-6 flex flex-col" style={{ borderColor: 'var(--border)', background: 'var(--bg)' }}>
              <div className="mb-3">
                ...
                <div className="flex items-baseline gap-1 mt-3">
                  <span className="text-[13px]" style={{ color: 'var(--text-muted)' }}>HK$</span>
                  <span className="text-[32px] font-semibold tracking-[-1px]">4,880</span>
                  <span className="text-[13px]" style={{ color: 'var(--text-muted)' }}>/mo</span>
                </div>
              </div>
              <div className="space-y-2.5 mt-5 flex-1">
                {[
                  ...
                  t('AI supplier matching', 'AI 供應商匹配'),
          ...
          <p className="text-[13px] text-center mt-8" style={{ color: 'var(--text-muted)' }}>
            {t('14-day free trial · Card required · Cancel anytime.', '14 天免費試用 · 需要信用卡 · 隨時取消。')}
          </p>
        </div>
      </section>
      ...
      {/* CTA */}
      <section style={{ background: 'linear-gradient(145deg, #0A6E5C 0%, #064E3B 100%)' }}>
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-24 text-center">
          ...
          <p className="text-[15px] md:text-[16px] mb-8 max-w-[500px] mx-auto" style={{ color: '#a7f3d0' }}>
            {t('From inquiry to quote in minutes. Start free today.', '從查詢到報價只需幾分鐘。今天免費開始。')}
          </p>
          <Link
            href="/signup"
            className="inline-block text-[15px] font-medium px-8 py-3.5 rounded-[4px] text-[#064E3B] hover:opacity-90 transition-opacity"
            style={{ background: '#FFFFFF' }}
          >
            {t('Get started free →', '免費開始 →')}
          </Link>
