    ...
    <div className="max-w-[960px] mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[18px] font-semibold">
              {subscriptionStatus === 'active' ? 'Vectra' : t('Free trial', '免費試用')}
            </p>
      ...
      <div className="border rounded-[4px] p-5 mb-6" style={{ borderColor: 'var(--border)', background: 'var(--surface)' }}>
        ...
        <p className="text-[13px] mb-3" style={{ color: 'var(--text-muted)' }}>
          {t('Let our team set up Vectra for you. We\'ll connect WhatsApp, upload your products, and configure the AI. This is a one-time fee on top of your subscription plan.', '讓我們的團隊為您設定 Vectra。我們會連接 WhatsApp、上傳產品並配置 AI。此為訂閱方案外的一次性費用。')}
        </p>
