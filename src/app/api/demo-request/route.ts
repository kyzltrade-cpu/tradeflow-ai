        ...
        await resend.emails.send({
          ...
          html: `
            ...
            <p style="margin-top: 16px;">
              <a href="mailto:${email}?subject=Re: Sailwise Demo Request" style="background:#000;color:white;padding:10px 20px;text-decoration:none;border-radius:4px;">Reply to ${name}</a>
            </p>
          `,
        });
      } catch (emailErr) {
