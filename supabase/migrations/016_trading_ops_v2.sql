...
-- ============================================================
-- 20. SEED DEFAULT REQUIREMENT TEMPLATES
-- ============================================================

INSERT INTO product_requirement_templates (company_id, category, template_name, required_fields) VALUES
-- Using a placeholder company_id; the app should create these per-company on setup
-- These are template definitions that get cloned per company
('00000000-0000-0000-0000-000000000000', 'bottles_containers', 'Bottles & Containers', '[
  {"field": "capacity", "label": "Capacity / Volume", "required": true},
  {"field": "material", "label": "Material / Grade", "required": true},
  {"field": "finish", "label": "Finish / Color", "required": false},
  {"field": "logo_method", "label": "Logo / Branding Method", "required": false},
  {"field": "packaging", "label": "Packaging Requirements", "required": false},
  {"field": "certifications", "label": "Testing / Certification", "required": false},
  {"field": "quantity", "label": "Quantity", "required": true},
  {"field": "destination", "label": "Destination", "required": true},
  {"field": "delivery_date", "label": "Delivery Date", "required": true}
]'::jsonb),
('00000000-0000-0000-0000-000000000000', 'pipes', 'Pipes', '[
  {"field": "diameter", "label": "Diameter", "required": true},
  {"field": "wall_thickness", "label": "Wall Thickness", "required": true},
  {"field": "length", "label": "Length", "required": true},
  {"field": "grade", "label": "Grade", "required": true},
  {"field": "standard", "label": "Standard (ASTM/DIN/JIS)", "required": true},
  {"field": "coating", "label": "Coating / Surface Treatment", "required": false},
  {"field": "quantity", "label": "Quantity", "required": true},
  {"field": "application", "label": "Application", "required": false},
  {"field": "certification", "label": "Certification", "required": false},
  {"field": "destination", "label": "Destination", "required": true},
  {"field": "delivery_date", "label": "Delivery Date", "required": true}
]'::jsonb),
('00000000-0000-0000-0000-000000000000', 'flanges_fittings', 'Flanges & Fittings', '[
  {"field": "material_grade", "label": "Material Grade", "required": true},
  {"field": "standard", "label": "Standard (ANSI/DIN/JIS)", "required": true},
  {"field": "size", "label": "Size", "required": true},
  {"field": "pressure_class", "label": "Pressure Class", "required": true},
  {"field": "connection_type", "label": "Connection Type", "required": true},
  {"field": "quantity", "label": "Quantity", "required": true},
  {"field": "application", "label": "Application", "required": false},
  {"field": "certification", "label": "Certification", "required": false},
  {"field": "destination", "label": "Destination", "required": true},
...
('00000000-0000-0000-0000-000000000000', 'aluminum_sheets', 'Aluminum Sheets', '[
  {"field": "alloy_temper", "label": "Alloy / Temper (e.g. 6061-T6)", "required": true},
  {"field": "thickness", "label": "Thickness", "required": true},
  {"field": "width_length", "label": "Width x Length", "required": true},
  {"field": "surface_finish", "label": "Surface Finish", "required": false},
  {"field": "quantity", "label": "Quantity", "required": true},
  {"field": "cutting", "label": "Cutting Requirement", "required": false},
  {"field": "certification", "label": "Certification", "required": false},
  {"field": "destination", "label": "Destination", "required": true},
  {"field": "delivery_date", "label": "Delivery Date", "required": true}
]'::jsonb),
('00000000-0000-0000-0000-000000000000', 'cnc_parts', 'CNC Parts', '[
  {"field": "cad_drawing", "label": "CAD Drawing / File", "required": true},
  {"field": "material", "label": "Material", "required": true},
  {"field": "tolerance", "label": "Tolerance", "required": true},
  {"field": "surface_treatment", "label": "Surface Treatment", "required": false},
  {"field": "quantity", "label": "Quantity", "required": true},
  {"field": "prototype", "label": "Prototype Required", "required": false},
  {"field": "inspection_standard", "label": "Inspection Standard", "required": false},
  {"field": "destination", "label": "Destination", "required": true},
  {"field": "delivery_date", "label": "Delivery Date", "required": true}
]'::jsonb)
